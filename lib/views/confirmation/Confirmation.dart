          ...
          children: [
            ...
            Align(
              ...
              child: GestureDetector(
                onTap: ()=> ExtendedNavigator.root.push(Routes.bookingPlace),
                child: Container(
            ...
            Positioned(
                ...
                left: 15,
                child: InkWell(
                  onTap: () => ExtendedNavigator.root.push(Routes.visaDetailsAddress),
                  child: Card(
              child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Container(
                          child: Image.asset(Res.pament,height: 50,),
                        ),
                        Container(
                          child: myText(text: 'Payment on arrival',color: Colors.black,size: 14),
                        ),
                      ],
                    ),
                    Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          children: [
                            Container(
                              child: Image.asset(Res.pament,height: 70,),
                            ),
                            Container(
                              child: myText(text: 'Payment on arrival',color: Colors.black,size: 17),
                            ),
                          ],
                        ),
                        Container(
